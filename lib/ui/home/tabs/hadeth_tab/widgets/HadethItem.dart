...
class HadethItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){
        Navigator.pushNamed(context, HadethDetailsScreen.routeName,arguments: hadithModel);
      },
      child: Container(
        ...
        child: Column(
          children: [
            Expanded(
              child: Padding(
                ...
                child: Column(children: [
                  Row(
                    children: [
                      Expanded(child: Image.asset(AssetManager.leftHadithCorner)),
                      Expanded(
                        flex: 2,
                      ...
                      Expanded(child: Image.asset(AssetManager.rightHadithCorner)),
                    ],
                  ),
                  Expanded(
                    child: Stack(
            ...
            Image.asset(AssetManager.hadeithMosque,
